...
public abstract class AbstractPendulum {
     ...
     */
    public AbstractPendulum (double inLength, double inMass, double inTheta0, GravityModel gm) {
	...
	if (validGC (gm.getGravitationalField())) this.gm = gm;
	else throw new IllegalArgumentException ("invalid local gravitational field: " + gm.getGravitationalField());
    }
    ...
    public void setGravityModel(GravityModel gm) {
    	if(validGC (gm.getGravitationalField())) this.gm = gm;
    		...
    		throw new IllegalArgumentException ("invalid local gravitational field: " + gm.getGravitationalField());
    }
}
